...
class BaseBEVBackbone(nn.Module):
    def __init__(self, model_cfg, input_channels):
        ...
        self.model = HighResolutionNet(
            input_channel=model_cfg.get('input_channel', None),
            last_channel=model_cfg.get('last_channel', None),
            inverted_residual_setting=model_cfg.get('inverted_residual_setting', None),
        )

        self.num_bev_features = model_cfg.get('last_channel', None)
